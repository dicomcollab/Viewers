  ...
  return (
    <div className="bg-primary-active/20 flex flex-col gap-2 border-b border-primary-active/40 px-2 py-3">
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-white text-base">{t('Preview edits before creating')}</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-white text-base">{t('Use center as segment index')}</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-white text-base">{t('Hover on segment border to activate')}</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-white text-base">{t('Show segment name on hover')}</span>
      </div>
    </div>
  );
}
